...
export default function AlertSection() {
  ...
  const alerts = [
    ...
    {
      module: "Probabilistic Machine Learning",
      surveyno: 1,
      duedate: "2023-09-08",
    ...
    {
      module: "Advanced Time Series Analysis",
      surveyno: 5,
      duedate: "2023-10-10",
  ...
  if (alerts.length > 0) {
    return (
      <div className='my-5'>
        <h5 className='tracking-wider flex-grow mb-3'>
          Meine laufenden Befragungen
        </h5>
  ...
  return (
    ...
    >
      <div className='date relative ml-5'>
        ...
        <p className='absolute bottom-2.5 ml-2 text-[14px]'>
          {due_date.getDate()}
        </p>
