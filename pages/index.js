  ...
  return (
    <RootLayout show_billboard={true}>
      <main className="flex-row justify-between px-10 pt-10">
        ...
        <div className="mt-8 flex space-x-2 mb-12">
          <div className="flex-1 items-center rounded-xl p-2 bg-lightpurple pl-6">
            <div className='flex items-center'>
              ...
              <div className="metric-text tracking-wider "><p>Modulen beigetreten</p></div>
            </div>
          </div>
          <div className="flex-1 items-center rounded-xl p-2 bg-lightgreen pl-6">
            <div className='flex items-center'>
              ...
              <div className="metric-text tracking-wider "><p>Rückmeldequote</p></div>
            </div>
          </div>
          <div className="flex-1 relative items-center rounded-xl p-2 bg-zoom bg-center pl-6 bg-lunapurple" style={{ backgroundImage: 'url("solarsystem.png")' }}>
            ...
            <div className='flex items-center'>
              ...
              <div className="tracking-wider metric-text z-10 "><p>Highlight-text</p></div>
            </div>
        ...
        <a href="#" className='flex border border-lightpurple rounded-full my-5 s-50 py-3 pl-5 hover:border-lunapurple z-1'>
