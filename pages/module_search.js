      ...
      try {
        ...
        if (router.query.id) {
          const response = await axios.get(
            `https://mz-bdev.de/api/${router.query.id}/university/modules`
          )
    ...
    <RootLayout>
      <main className='flex-row justify-between px-10 pt-10'>
        ...
        <p className='text-lightgrey'>
          Available modules are determined by your enrolled course / degree. To
          join a module outside of your standard faculty,{" "}
