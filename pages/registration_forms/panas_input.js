                ...
                <main className='flex-row justify-between px-10 pt-10'>
                    <form onSubmit={handleFormSubmission}>
                        ...
                        <p className='mb-10 text-lightgrey'>
                            Die deutsche Version des Positive and Negative Affect Schedule (PANAS)
                            wurde aus dem weit verbreiteten englischen Instrument zur Erfassung der
                            emotionalen Befindlichkeit von Watson, Clark und Tellegen (1988)
                            adaptiert. Der Fragebogen besteht aus 20 Adjektiven, die verschiedene
                            Empfindungen und Gefühle beschreiben. Jeweils 10 Adjektive erfassen die
                            Dimensionen Positiver Affekt und Negativer Affekt. Die Skala kann für
                            unterschiedliche Untersuchungsziele eingesetzt werden. Je nach
                            Instruktion können sowohl aktuelle, zeitlich begrenzte Affekte als auch
                            überdauernde, habituelle Affektmerkmale gemessen werden.
                        </p>
