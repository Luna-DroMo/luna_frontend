      ...
      try {
        if (router.query.id) {
          const response = await axios.get(
            `https://mz-bdev.de/api/module/${router.query.id}`
          )
        ...
        <div className='rounded-xl bg-white px-5 py-5 mb-4'>
          ...
          <div className='w-4/6 mb-4 text-lightgrey'>
            <p>
              ...
              viverra laoreet arcu, ullamcorper aliquam augue lobortis
              elementum. Pellentesque habitant morbi tristique senectus et netus
              et malesuada fames ac turpis egestas. Nulla aliquet accumsan
              libero, et porta erat. Phasellus tristique purus non sapien
              elementum interdum. Suspendisse tristique, lorem a dictum
              tincidunt, erat elit cursus sem, non rhoncus elit urna ac arcu.
              Cras lacinia egestas sapien quis dignissim.
            </p>
          </div>
        </div>
